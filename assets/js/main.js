...
(function () {
  ...
  /* ── Hero slideshow — pure CSS crossfade, no JS animation resets ── */
  const slides = document.querySelectorAll('.hero-slide');
  let current = 0;

  // Each slide stays fully visible for 7s; the 2.2s CSS fade overlaps both
  // sides so there is never a gap or flash to black between images.
