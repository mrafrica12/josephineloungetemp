  ...
  function getColumnConfig(view) {
    const configs = {
      reservations: [
        ...
        { key: 'Full Name',      label: 'Name',       type: 'bold' },
        { key: 'Phone',          label: 'Phone',      type: 'phone' },
        { key: 'Preferred Date', label: 'Event Date', type: 'text' },
        { key: 'Party Size',     label: 'Guests',     type: 'text' },
    ...
    const html = `
      <div style="display:flex;align-items:center;justify-content:space-between;margin-bottom:1rem;flex-wrap:wrap;gap:0.75rem">
        ...
        <div style="display:flex;gap:0.75rem;align-items:center">
          <a href="../../pages/events.html" target="_blank" rel="noopener noreferrer" class="btn btn-outline btn-sm">↗ View Public Page</a>
