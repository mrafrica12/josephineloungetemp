...
(function () {
            ...
            <div class="panel" style="overflow:hidden">
              ...
              <div class="panel-body" style="padding:1rem">
                ...
                <div style="display:flex;gap:0.5rem;flex-wrap:wrap">
                  ...
                  ${flyerUrl ? `<a href="${flyerUrl}" target="_blank" rel="noopener noreferrer" class="btn btn-sm btn-outline" title="View PDF">📄</a>` : ''}
  ...
  window.handleFlyerSelect = function (input) {
    ...
    if (file.size > maxMB * 1024 * 1024) {
      toast(`File too large. Max ${maxMB}MB for event flyers.`, 'error');
      input.value = '';
      return;
    }
    ...
    reader.onload = e => {
      flyerBase64 = e.target.result; // Includes data:application/pdf;base64,... prefix
      ...
      document.getElementById('flyerFileSize').textContent = `${sizeMB} MB — ready to upload`;
    };
  ...
  window.submitEvent = async function () {
    ...
    const payload = {
      ...
      flyerName:   flyerName   || `${eventName} Flyer.pdf`,
    };
